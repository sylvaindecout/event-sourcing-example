...
import static fr.xebia.sdecout.eventsourcing.reminder.domain.CommandHandler.DEFAULT_COUNTRY;
import static fr.xebia.sdecout.eventsourcing.reminder.domain.ReminderEventStream.emptyEventStream;
