package fr.xebia.sdecout.eventsourcing.reminder;
...
@AnalyzeClasses(packages = "fr.xebia.sdecout.eventsourcing")
class ArchitectureTest {

    @ArchTest
    public static final ArchRule domain_is_isolated = classes()
            .that()
            .resideInAPackage("fr.xebia.sdecout.reminder.domain..")
            .should()
            ...
            .resideInAnyPackage(
                    ...
                    "org.mockito..",
                    "org.assertj..",
                    "fr.xebia.sdecout.eventsourcing.reminder.domain..",
                    "fr.xebia.sdecout.eventsourcing"
            )
